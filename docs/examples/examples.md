...
⚠ at least one donation needs REVIEW — its appraiser/donee declaration is incomplete. Run `btctax reconcile set-donation-details …` to complete it.
```
...
Filled IRS forms for tax year 2024 →
