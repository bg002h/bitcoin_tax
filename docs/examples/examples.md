...
$ btctax --vault v.pgp income show --year 2024
{
  ...
  "header": {
    ...
    "dependents": [
      {
        ...
        "joint_return_only_to_claim_refund": null,
        ...
        "qr_relationship_or_member_of_household": null,
        "qualifying_child_of_any_taxpayer": null,
        "gross_income_under_limit": null,
        "you_provided_over_half_support": null,
        "divorced_separated_multiple_support_or_kidnapped_rule_applies": null
      }
    ],
    ...
    "qss_child_lived_in_your_home_all_year": null,
    "qss_paid_over_half_cost_of_keeping_up_home": null,
    "qss_could_have_filed_jointly_in_year_of_death": null,
...
⚠ a Section B Form 8283 is NOT filing-ready without a signed Part IV (appraiser) and Part V (donee acknowledgement) — obtain both before filing.
  ...
  • RETURN OPTIONS NOT OFFERED — v1 fills a calendar-year Form 1040, and it offers none of
    the following: a FISCAL YEAR (the "For the year Jan. 1–Dec. 31" line stays as printed),
    ...
    SPLITTING your refund across accounts (Form 8888, the line 35a box), and your email
    address. None of THOSE FIVE changes your tax; each is a choice the printed return leaves
    blank because btctax never asked, and if you want any of them, mark the form by hand
    before signing. ONE FURTHER CELL IS LEFT BLANK AND IT IS NOT ADMINISTRATIVE: the
    §6013(g)/(h) election to treat a NONRESIDENT-ALIEN SPOUSE as a U.S. resident, on the
    Filing Status block of page 1. That election DOES change your tax — it is what makes a
    joint return available when one spouse is a nonresident alien, and it subjects that
    spouse's WORLDWIDE INCOME to U.S. tax for the entire year, for every later year until it
    is revoked. btctax never asked whether you have a nonresident-alien spouse and has
    computed nothing for one: the figures on this return are your own income alone. So do
    NOT check that box by hand — checking it without adding that spouse's worldwide income
...
═══ The interview — tax year 2024 ═══
  ...
  Documents received (the census)
    ...
    Form 1099-DIV                                no         0 row(s) transcribed
    Form 1099-B                                  no         0 row(s) transcribed
    Form 1099-G                                  no         0 row(s) transcribed
    Form 1098                                    no         0 row(s) transcribed
    ...
    Form 1099-S                                  no         no section holds rows of this type
    Form 1099-OID                                no         no section holds rows of this type
    Form W-2G                                    no         no section holds rows of this type
    Form 1099-C                                  no         no section holds rows of this type
    Form 1095-A                                  no         no section holds rows of this type
    Form 1098-T                                  no         no section holds rows of this type
  ── The answer panel (tax year 2024) ──
    FORGOING (5) — lawful to skip; each one costs YOU, not the Treasury:
      ...
      • Is YOUR SPOUSE legally blind? (§63(f) additional deduction) — up to $1550
  ...
  Where each figure came from (6 figure(s) with an amount; a box left at zero carries no testimony and is not listed)
    w2s[0].box1_wages                              $400000         Form W-2 #1 Front Range Health
    w2s[0].box2_fed_withheld                       $96000          Form W-2 #1 Front Range Health
    w2s[0].box3_ss_wages                           $168600         Form W-2 #1 Front Range Health
    w2s[0].box4_ss_withheld                        $10453.20       Form W-2 #1 Front Range Health
    w2s[0].box5_medicare_wages                     $400000         Form W-2 #1 Front Range Health
    w2s[0].box6_medicare_withheld                  $7150           Form W-2 #1 Front Range Health
```
