...
> 4. **Owner questions still open, never actioned autonomously:** Q1, Q2, Q4 (deposit vs paper check — T10 built the field so either answer is expressible and decided nothing); S1, S2, S7; T7's Notice 2026-20 order; the simulated real return (FR-64 — the owner's TY2024 return is the reference and never enters the repo).
