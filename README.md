...
Supported years: **2024** and **2025** — btctax fills the right revision per year. On **2025**
...
1040 capital gain is **line 7**, and Form 8283 is **Rev. 12-2023**.

> **TY2017 no longer fills forms.** btctax shipped a TY2017 form package until 2026; it was dropped
> because none of its five blank PDFs had an archived primary source behind it, so nothing could
> re-derive or verify them. `export-irs-pdf --tax-year 2017` now refuses and names the years that
> remain. **`report --tax-year 2017` still computes** — the TY2017 tax table (Rev. Proc. 2016-55) is
> still bundled, so a 2017 crypto delta is still a number btctax will give you; you just fill the
> paper yourself.
...
- **`f8949.pdf` + `schedule_d.pdf`** — always. Bitcoin is filed under the year's digital-asset boxes
  (**Box I/L** on 2025, **Box C/F** on 2024) — never the wrong pair. Rows beyond a part's grid (11
  in 2025, 14 in 2024) paginate onto multiple copies, each with its own totals; Schedule D carries
  the grand totals.
...
- **`form_8283.pdf`** — when you made **BTC donations**. Fills the donee/appraiser **identity** and
  ...
  is **"k Digital assets"** on the Rev. 12-2023/2025 forms. It leaves **every other party's declaration/signature blank**
...
- **`form_1040_capgains.pdf`** — when there is reportable capital/digital-asset activity. btctax fills
  the **capital-gain line** (**7a** in 2025, **7** in 2024, when Schedule D is active and
  line 16 ≥ 0; active-and-netted-to-zero prints `-0-`; a **net loss leaves it blank** — the §1211
  $3,000/$1,500-MFS cap on Schedule D line 21 is yours), and the **Digital-Asset
  question** (**Yes** iff you had any disposal, income, gift, or donation — never a "No"). The 7b checkboxes
...
btctax bundles official IRS form templates for **2024 and 2025** only. A flagged year outside that set —
which includes 2017–2023, the years a lost-records shortfall most often lands in — is reported as *"no bundled
