...
| **IRC §55** Alternative minimum tax imposed — **USCODE-2024 edition, PRE-OBBBA base text** | `26USC_s55.html` | `c17459905d89` | AMT: §55(b) rates/breakpoints, §55(d)(1) exemptions, §55(d)(2)–(4) phase-out. ★ This edition still reads "before January 1, 2026" and a **25 percent** phase-out; see the two rows below. Added 2026-09-05 (FR-47). |
| **Pub. L. 119-21** (One Big Beautiful Bill Act, 2025-07-04), 139 Stat. — **the AMENDING law**; §70107 at 139 Stat. 162–163 | `PLAW-119publ21_OBBBA.pdf` (govinfo `PLAW-119publ21`); text layer `legal/text/statute-irc/PLAW-119publ21_OBBBA.txt` | `42f86c3d408b` | §70107(a) makes the §55(d)(4) reset permanent; **§70107(c) substitutes "50 percent" for "25 percent"** in §55(d)(4)(A)(ii); §70107(d) effective for taxable years beginning after 2025-12-31. **This, not Rev. Proc. 2025-32, is the authority for the TY2026 0.50 phase-out rate** — the Rev. Proc. publishes the resulting dollar amounts (§2.10). Also the source for the Schedule 1-A deductions (Title VII subtitle A part I). |
| **IRC §55** — **OLRC "prelim" edition, post-OBBBA CONSOLIDATED text** (uscode.house.gov, `USC-prelim-title26-section55`) | `26USC_s55_OLRC-prelim.html` | `bddb1231ebb7` | The amended §55(d) in one place, reflecting Pub. L. 119-21. ★ NOT the govinfo USCODE-2024 series the other rows use — a different publisher edition, archived so the amended subsection is readable without applying §70107 by hand. ★★ **Hash is not re-fetch-stable**: the page embeds a JSF `jsessionid` and `ViewState` token per request (28 changed lines between two fetches, all tokens, statute text identical). Verify by TEXT, not by sha256, when re-fetching. |
