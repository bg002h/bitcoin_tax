...
| **Direct deposit** of a refund (1040 lines 35b–35d) | Faster refund. | **btctax fills this block now** — enter your routing and account numbers and the type of account (the tax-inputs editor, or `btctax income import`) and lines 35b–35d are printed. If you give none, they stay blank, you receive a **paper check**, and the report says so. |
