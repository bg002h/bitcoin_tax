...
Last updated: **2026-09-05**. The year-package table design is `design/FORM_AUTHORITY_TABLE_DESIGN.md` (DRAFT, awaiting the Fable plan review). Next year: `design/TY2026_PORT_REPORT.md` (the decision report) and
