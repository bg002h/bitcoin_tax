...
| **S6** | **RULED 2026-09-06 ("Then use that strategy going forward") — recorded in `STANDARD_WORKFLOW.md` §2 and the memory `one-review-round-then-execute`.** **Right-size ceremony for a one-person autumn**: one review round per document then execute; fan-outs ≤ 6 lenses; no new instrument without a named consumer on the owner's path. KEEP every compute/emitter/provenance gate, B1 kills, the two-oracle census, the single B3 pre-mail review | `STANDARD_WORKFLOW.md`'s "review to 0C/0I" on prose artifacts | measured: 1,233 commits in July, 180 in August; five review rounds on one plan; the test is whether one person can repeat the autumn in 2027 |
...
| **S9** | **Drop TY2017** — **RULED 2026-09-06: DROP** ("S9 drop"). The five wired forms, their rows and every gate entry are GONE (FR-61, done 2026-09-06, 3168 tests); the TY2017 `TaxTable` is KEPT so `report --tax-year 2017` still computes the crypto delta (the ruling's own option; say the word and it goes too) | delete five wired forms + their rows in every glob-walking gate; keep the tax table if the 2017 crypto slice is wanted | zero evidence behind it (no authority, notes, geometry or census); under design r2 it is a row in every gate forever |

The four non-owner items (S3 1099-DA input NOW; S4 machinery hard stop 2026-10-31 then a hand port;
S5 real-data runs at the 2026-09-15 and 2027-01-15 estimate dates — ★★ **WITHDRAWN by owner ruling 2026-09-09: "We will not consider estimated quarterly payments this year."** The 2026-09-15 run is cancelled and the 2027-01-15 run is no longer an ESTIMATE driver. The price refresh (FR-53) therefore drops from *this week* back to its scheduled 2027-01-02 slot, where it is still required for the RETURN itself. ★ Not actioned, recorded once: skipping estimates is penalty-free under §6654 only if withholding meets a safe harbour — for AGI over $150,000 that is **110% of the prior year's total tax** — and withholding counts as paid evenly through the year, so a wage earner is usually covered. The exposure, if any, is crypto gains that withholding does not reach. The owner has ruled; this note exists so the ruling is on the record as an informed one, not so it is revisited; S8 a physical print rehearsal +
...
- **S10 (spec 1099-DA r3/r4, 2026-09-06) — the crypto-slice `export-irs-pdf` is CLOSED on a LIVE
  ...
  **★ RULED 2026-09-06 — REVERSED:** *"we will need to have option to file 2026 tax year with crypto
  ...
  review (1C/2I/4M/1N — the Form 8283 restriction gate had been left on one arm) is folded
  `d81eea8c` and re-verified 8/8, 0C/0I. **FR-62 CLOSED; R6 is GREEN** (3185 tests).
...
- **THE SIMULATED REAL RETURN (owner, 2026-09-07: "We will plan to use the interview to simulate a
  ...
  (`HsaActivityUnsupported`) — FR-76, **RULED 2026-09-07: transcribe Form 8889 as task T16**
  (`BRIEF-build-interview-T16.md`), scheduled immediately after T6 closes and ahead of T7. The filed return is the third witness for the
...
|---|---|---|
| **NOW** | nothing — statute / Rev. Proc. / regime already in the tree | `FullReturnParams` TY2026 incl. `AmtParams` (Rev. Proc. 2025-32 §2.10; **statute archived `58200a59`** — Pub. L. 119-21 §70107(c) is the authority for 0.50); **the 1099-DA input surface (FR-46 b/c) — by end of September, and the owner's broker specific-ID instruction to each exchange before further 2026 sales (strategy S3)**; `YEAR.toml` + `YearReadiness` (build-order 1b); **the year-package table, design r2 §10 steps 1–5 only, hard stop 2026-10-31 — the `forms port` generator and Layer-4 codegen wait until one TY2026 form has been ported by hand (S4). Steps 1–4 DONE (`6267b6b1` the row on all 37 maps; `68b86b8e` build.rs + generated bindings; `bc6dce35` the fillers on the glob, 54 consts + the year hand-list gone; `11a52555` YEAR.toml + YearReadiness) — each phase independently reviewed and folded; the first kill found FR-55 (Form 8283 stapled last for TY2025). Step 5 **DONE 2026-09-11 — NINE OF TEN WIRED**: `f6251/2025` landed and closed at 0C/0I (build `d8d023af` → seam review `fbe9d788` 0C/2I → fold `6356043e` → re-verification `78d77754` 0C/1I → fold `99468b5d` → re-verification `bb2cb7ab` 0C/0I/0M/2N; `make gate` 3596/12). The round's finding: Schedule 1-A **37 → 43 is a COLLISION, not a renumber** — TY2026 refilled line 37 with the MAGI, so reusing the TY2025 cross-reference overstates the AMT base by ≈MAGI, and two source comments said "renumber" while one prescribed the dangerous edit. Now held by a type, not by prose. `f1040s1a/2025` stays `Unwired` PERMANENTLY (owner ruling: TY2025 is never filed; TY2026's Schedule 1-A is a rebuild, 10 of 219 fields survive) — so the 2026-10-31 hard stop is MET**; the Form 8995 line-16/17 and Schedule A instrument variants; **two real-data runs of `report --tax-year 2026` on the owner's 2026 exports, for the 2026-09-15 and 2027-01-15 estimates (S5)**; the price dataset through 2026-12-31 (FR-53; a 2027-01-02 task); **taxcalc → 6.8.2 — DONE 2026-09-05 (rule 12 applied: #3108 fixed upstream, gap #1 deleted, version floor added; the `AMT_em_pe` 639,200-vs-$640,200 MFS cell is still to be recorded as a mechanism-computed excuse when the TY2026 census is written)**; **Form 4868 + 1040-V (FR-49) and a physical print rehearsal — assemble by attachment sequence, sign block, envelope, payment — done once on a packet before the season (S8)**; **THE INTERVIEW (owner ask 2026-09-07, `LONG_RANGE_PLAN_filing.md` Phase 7): spec `SPEC_interview.md` r1 + its one review (S6) → build T1–T12 by one opus agent per task — **T1 (provenance schema) CLOSED 2026-09-07**; **T2 (the information returns archived PER REVISION for TY2024/25/26 — 31 documents, 15 editions, a 246-box census; seam review 1C/3I folded `0c942ac2`, re-verified 0C/0I `e1c578e1`) CLOSED 2026-09-07; FR-65 → T5**; **T3 (document census, direction tables, answer panel) CLOSED 2026-09-07** (`0807335b` + pre-review fold `d44f82e4`; seam review 0C/5I folded `750c1b34`; re-verified 0C/0I/0M/0N; FR-66/67/68 → T5/T8/T5); **T4 (year gate + draft protection) CLOSED 2026-09-07** (`bbcee739`; seam review 1C/0I folded `4ad17aaa` — the disposable-draft predicate made structural; re-verified 0C/0I/0M/1N); **T4b (the year-N+1 opener) CLOSED 2026-09-07** (`44ca7075`; seam review 1C/3I folded `4af15ab4` — an identity crosses only where this year has a surface to answer it; re-verified 0C/0I/0M/0N; FR-69/70 filed); **PUSHED 2026-09-07 → origin/main `f91359c7`** (the pre-push PII gate's two blockers fixed/ruled, FR-71 filed); **T5 (the 1099 sections) CLOSED 2026-09-07** (`34472416` + `9a845dc5`; seam review 0C/4I folded `2fe4ba5f` — the box→FieldId join's kill now runs the instrument; re-verified 0C/0I/2M/0N; FR-72 filed); **T6 (the exchange seam) CLOSED 2026-09-07** (`a79492ee`; seam review 1C/1I folded `71b91a26` — the crypto slice's Digital Assets box is the filer's answer or nothing; re-verified 0C/0I/0M/0N; FR-73/74/75/77 filed); **T16 (Form 8889, the owner's ruling) CLOSED 2026-09-07** (`86bc9171`+`4b241dd7`; seam review 1C/3I folded `79e3bb6e` — both legs in the absolute chain, the two-chain instrument now structural; re-verified 0C/0I/0M/0N with both oracles re-run live; FR-78/79/80 filed) — **the owner's filed TY2024 form set is now fully buildable**; **T7 (the dependents gates) CLOSED 2026-09-07** (`282a8a32`; seam review 1C/5I folded `2213eeb5` — the gates hash the registry's words, a dependent's identity decided, FR-81 closed; re-verified 0C/0I/0M/0N) (FR-82/83 filed); **T8 (row (7), HoH/QSS, the TY2025 grid) CLOSED 2026-09-07** (`f7b5407b`; seam review 0C/3I folded `a17b9d6a` — the dependents grid now asks the WALK, not the leaf, so a retracted answer cannot print as a checkbox; the §24(h)(2) CTC pin moved to the crate that can see the bundle and was watched red on it; the 1040 header's shared entry space serves HoH AND QSS; re-verified 0C/0I/0M/0N; FR-84/85 filed, FR-86 filed); **T9 (real estate — R8) CLOSED 2026-09-07** (`18935bfd`; seam review 1C/1I folded `0f6603a9` — the itemize election now has ONE reader, `form_1098_deducted()`, that every Schedule A line-8 rule goes through, so a standard-deduction filer holding a 1098 is asked nothing and refused nothing again (J-24 restored); line 8b's *"See attached"* names its recipients in the manifest; SPEC R8 corrected to say one thing; re-verified 0C/0I/0M/0N; FR-87 filed); **T10 (the trailer — §5.4) CLOSED 2026-09-07** (`f8768e93`; seam review 0C/3I folded `08c09ecc` — the opener now NAMES every leaf it carries and its guard is fed a fixture DERIVED from `maximal_sentinel`, which immediately surfaced four more unnamed carries from T7/T9/T16; line 35c refuses until the filer chooses the box, so a savings filer no longer files a Checking mark they never made; the ABA rule's justification now says what the code does; re-verified 0C/0I/0M/0N with all 21 build kills replanted; FR-89/90 filed); **T11 (the oracle path — R13) CLOSED 2026-09-07** (`46d4b2d6`; seam review **2C/4I/3M/1N** — the heaviest of the arc — folded `ebe5bbec`: the oracle check now runs the FILER'S refuse chain and can exit 2 (exit 2 did not previously exist at all), an itemizing filer reaches OTS's Schedule A, a sworn `0` is no longer read as a forgone blank (linked to FR-85 and pinned in `--selftest`), all five filing statuses map `_`-free, and a DERIVED routing partition over 717 non-`Usd` perturbations found FOUR latent money defects both oracles were blind to — Sch A 5a missing W-2 box 17+19, 8a missing 1098 points and the §163(h)(3)(F) zeroing, `hsa_deduction` ignoring `sch1.hsa_activity`; re-verified 0C/0I/0M/0N; FR-91..96 filed); **T12 (the render pass — R12) CLOSED 2026-09-07** (`833ce3f1`; seam review 1C/2I folded `cf319fc4` — the filer can now reach the end of the answer panel (the key handler re-clamped by LOGICAL lines after the renderer had clamped by WRAPPED rows, hiding 47% of the panel including the FORGOING tail, and the kill was the arc's FOURTH shadow: it assigned `panel_scroll` and never pressed a key), and BOTH completeness lists were fixed by DELETING a hand list — the refusing list now runs the commit screen's own value tier, and `undated_document_rows` walks `DocumentKind::ALL` exhaustively; re-verified 0C/0I/1M/0N; T12's four owned follow-ups FR-73/83/86/87 all CLOSED in the task that owned them; FR-97/98/99 filed) — **THE INTERVIEW ARC IS BUILT: T1–T12 and T16 all closed at 0C/0I**; ★★ **v1 TASK SCOPE SETTLED 2026-09-07 by owner ruling — T13 DEFERRED (no self-employment and no business, so its Schedule C half is out; the 1099-MISC half deferred at the owner's direction), T14 CLOSED as NOT NEEDED (no 1099-R, no SSA-1099), T15 DEFERRED post-v1 (owner Q2 — the CTC is zero at this income). The interview is therefore COMPLETE for v1: every task that v1 needs is built and closed at 0C/0I.** Deferring T13 fails CLOSED — an arriving 1099-MISC refuses the return with its reason rather than filing something wrong — so the trigger to watch is the form arriving, not the filing date. One Q1 row is still open and cheap: Form 1095-A, the only row that refuses the entire return; briefs through T12 committed (`3142775d`, seam review 1C/1I folded `d49de0c7`, re-verified 8/8 0C/0I; `income import` was a second writer of the answer log — every writer is now enumerated in each brief); T2 (the archived information returns + box censuses) building; authoring the owner's TY2026 return in Sep–Dec depends on T1–T4** |
